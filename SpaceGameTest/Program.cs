...
namespace SpaceGameTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string name;
            Story.Prologue();
            string genderResponse = Console.ReadLine();
            string genderMale = "male";
            string genderFemale = "female";
           /* if (genderResponse.Trim().ToLower() == genderMale.Trim().ToLower())
           // {
           //     Console.WriteLine("Alright brother lets do this! press enter to continue...");
           //     Console.ReadLine();
           // }
           //else if ( genderResponse.Trim().ToLower() == genderFemale.Trim().ToLower())
           // {
           ...
           // //get the option to change Master Chiefs name? Let's talk through it.
