...
namespace SpaceGameTest
{
    class StoryLine
    {
        ...
        { 
            Console.WriteLine("\n\n\nIn the galaxy called Milky Way, there has been a war going for a very long time.\n" +
        ...
        public void ChapterOnePartOne()
        {
            Console.WriteLine("\n\n\nFrom now on you will be refered to as \"Cadet\" The Cadet arrives at the Space HQ to start their training as a recruit. \n" +
                              "The user gets his first mission, it is to go on Mars and retrieve an ore, it is said to have magical powers which would be\n beneficial to the Space Force. ");
        }
